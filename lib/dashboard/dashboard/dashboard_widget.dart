                      ...
                      Row(
                        ...
                        children: [
                          ...
                          FlutterFlowIconButton(
                            ...
                            onPressed: () async {
                              context.pushNamed(VoiceWidget.routeName);
                            },
                          ),
                          FlutterFlowIconButton(
                            borderRadius: 12.0,
                      ...
                      children: [
                          ...
                          children: [
                            Expanded(
                              child: InkWell(
                                ...
                                onTap: () async {
                                  context
                                      .pushNamed(PolicenearbyWidget.routeName);
                                },
                                child: Container(
                                  width: double.infinity,
                                  decoration: BoxDecoration(
                            ...
                            Expanded(
                              child: InkWell(
                                ...
                                onTap: () async {
                                  context.pushNamed(
                                      HospitalnearbyWidget.routeName);
                                },
                                child: Container(
                                  width: double.infinity,
                                  decoration: BoxDecoration(
                        ...
                        Align(
                          ...
                          child: InkWell(
                            ...
                            onTap: () async {
                              context
                                  .pushNamed(EmergencyHelplineWidget.routeName);
                            },
                            child: Container(
                              width: double.infinity,
                              height: 55.0,
                          ...
                          Column(
                            ...
                            children: [
                              InkWell(
                                ...
                                onTap: () async {
                                  context
                                      .pushNamed(MycommunityWidget.routeName);
                                },
                                child: Icon(
